...
<html lang="en">
  <head>
    ...
    <title>{{ $bs->title }} | MyTaxZone</title>
    <meta name="description" content="{{ Str::limit(strip_tags($bs->content), 160) }}">
    <meta name="keywords" content="{{ $bs->title }}, MyTaxZone, Tax Guide, Tax Filing, Income Tax, GST, Finance, {{ $bs->tags }}">
    @endforeach
...
<section class="page-banner page-title parallaxie" data-bg-img="{{ asset('assets/images/bg/home.png') }}">
  <div class="container">
    <div class="row">
      <div class="overlay"></div>
      <div class="col">
        <h1 class="banner-title">Business Services</h1>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-8 col-md-12">
          <h2 class="title mb-3">{{ $bs->title }}</h2>
          {{-- <p class="mb-0">Cms Business is facility to produce adipisicing elit. Excepturi vero aliquam id. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Excepturi vero minima impedit aliquam id.</p> --}}
          @if($bs->image)
            <img class="img-fluid w-100 rounded box-shadow my-4" src="{{ asset($bs->image) }}">
          @endif
          <p>{!! $bs->content !!}</p>
          <div class="row mt-5">
          ...
          <div class="widget mb-5">
            <div class="sidebar-links">
              <ul class="list-unstyled">
                ...
                {{-- <li>
                  <a href="software-research"><span class="link-icon link-arrow"></span> <p class="link-text">Software & Research</p> </a>
                </li> --}}
                <li>
                  <a href="{{ route('finance_services') }}"><span class="link-icon link-arrow"></span><p class="link-text">Finance and Restructuring</p> </a>
                </li>
                {{-- <li>
                  <a href="energy-environment"><span class="link-icon link-arrow"></span><p class="link-text">Energy & Environment</p> </a>
                </li> --}}
                <li>
