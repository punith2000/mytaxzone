...
<html lang="en">
  <head>
    ...
    <title>{{ $invest->title }} | MyTaxZone</title>
    <meta name="description" content="{{ Str::limit(strip_tags($invest->content), 160) }}">
    <meta name="keywords" content="{{ $invest->title }}, MyTaxZone, Tax Guide, Tax Filing, Income Tax, GST, Finance, {{ $invest->tags }}">
    @endforeach
...
<section class="page-banner page-title parallaxie" data-bg-img="{{ asset('assets/images/bg/Invest.webp') }}">
  <div class="container">
    <div class="row">
      <div class="overlay"></div>
      <div class="col">
        <h1 class="banner-title">Investment</h1>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-8 col-md-12">
          <h2 class="title mb-3">{{ $invest->title }}</h2>
          {{-- <p class="mb-0">Investment Planning is facility to produce adipisicing elit. Excepturi vero aliquam id. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Excepturi vero minima impedit aliquam id.</p> --}}
          {{-- <img class="img-fluid w-100 rounded box-shadow my-4" src="{{ asset('assets/images/services/large/05.jpg') }}" alt=""> --}}
          @if($invest->image)
              <img class="img-fluid w-100 rounded box-shadow my-4" src="{{ asset($invest->image) }}">
          @endif
          <p>{!! $invest->content !!}</p>
          {{-- <p class="mb-0">consectetur adipisicing elit. Totam mollitia incidunt vero cupiditate obcaecati iusto tempora unde! Numquam officiis, quae adipisci quam laudantium nulla modi. adipisci quam laudantium nulla modi. Totam mollitia incidunt vero cupiditate obcaecati</p> --}}
          <div class="row mt-5">
        ...
        <div class="col-lg-4 col-md-12 sidebar mt-5 mt-lg-0">
          <div class="widget mb-5">
            <div class="sidebar-links">
              <ul class="list-unstyled">
                ...
                {{-- <li>
                  <a href="software-research.html"><span class="link-icon link-arrow"></span> <p class="link-text">Software & Research</p> </a>
                </li> --}}
                <li>
                  <a href="{{ route('finance_services') }}"><span class="link-icon link-arrow"></span><p class="link-text">Finance and Restructuring</p> </a>
                </li>
                {{-- <li>
                  <a href="energy-environment.html"><span class="link-icon link-arrow"></span><p class="link-text">Energy & Environment</p> </a>
                </li> --}}
                <li class="active">
          ...
          {{-- <div class="widget mb-5"> <a href="#" class="brochure"><i class="fas fa-file-pdf"></i> Download<span>Download.pdf</span></a>
          </div> --}}
          <div class="widget">
