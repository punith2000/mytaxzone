...
<body>
    <div class="container d-flex justify-content-center align-items-center vh-100">
        <div class="card p-4 shadow" style="width: 400px; background:linear-gradient(135deg,rgba(255, 255, 255, 0.1),rgba(255, 255, 255, 0.05));">
            <h3 class="form-title text-center mb-4">Welcome</h3>
            @if(session('success')) 
            ...
            <form action="{{ route('frontend.user_login.login') }}" method="POST">
                @csrf
                <div class="mb-3">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="{{ route('frontend.user_login.forgot_password') }}">Forgot Password?</a>
                </div>
            ...
            <p class="text-center mt-3" style="color: #ff7f32;">
              Don't have an account? <a href="{{ route('frontend.user_login.register') }}">Sign up</a>
            </p>
        </div>
    </div>
</body>
