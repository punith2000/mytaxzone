            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header flex items-center justify-between">
                  ...
                  <a href="{{ route('admin.features.add_feature') }}" class="btn btn-primary"><i class="bi bi-plus"></i> Add Post</a>
                </div>
                <div class="card-body">
                  @session('success')
                    ...
                    <tbody>
                      @foreach($features as $feature)
                        <tr>
                          <td>{{ $feature->id  }}</td>
                          <td>{{ $feature->title }}</td>
                          <td class="testimonial-content">{!! $feature->content !!}</td>
                          <td>
                            @if($feature->image)
                          ...
                          <td>
                            <a href="{{ route('admin.features.show', $feature->id) }}" class="btn btn-primary btn-sm">
                              <i class="fa fa-eye"></i>
                            </a>
                            <a href="{{ route('admin.features.edit', $feature->id) }}" class="btn btn-success btn-sm">
                ...
                <div class="center mt-3">
                  <div class="pagination">
                      ...
                      @if ($features->onFirstPage())
                          <span>&laquo;</span>
                      @else
                          <a href="{{ $features->previousPageUrl() }}" rel="prev">&laquo;</a>
                      @endif
                      ...
                      @if ($features->hasMorePages())
                          <a href="{{ $features->nextPageUrl() }}" rel="next">&raquo;</a>
                      @else
                          <span>&raquo;</span>
                      @endif
                  </div>
                ...
                <div class="d-flex justify-content-center text-muted mt-2">
                  <small>
                      Showing {{ $features->firstItem() }} to {{ $features->lastItem() }} of {{ $features->total() }} results
                  </small>
                </div>
