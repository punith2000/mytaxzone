    ...
    <div class="pc-container">
      <div class="mt-4">
        <div class="card card-box mb-2 ms-3 me-3">
          ...
          <div class="card-body">
            <p><strong>ID:</strong> {{ $feature->id }}</p><br>
            <p><strong>Title:</strong> {{ $feature->title }}</p><br>
            <p><strong>Content:</strong> {!! $feature->content !!}</p><br>
            <p><strong>Image:</strong><br>
              @if($feature->image)
                <img src="{{ asset($feature->image) }}" width="200">
              @endif
            </p>
          </div>
        </div>
