          ...
          <div class="col-md-9">
            <div class="card card-box mb-2">
              <div class="card-header">
                <h3>Home/Slider Edit
                  <a href="{{ route('admin.homes.home') }}" class="btn btn-danger float-end">
              ...
              <div class="card-body">
                <div class="form-group">
                  <label>Title: </label>
                  <input type="text" name="title" value="{{ $home->title }}" class="form-control" placeholder="Enter the title" required>
                </div>
                <br>
                ...
                <div class="form-group">
                  ...
                  class="form-control" placeholder="Content" required>{!! $home->content !!}</textarea>
