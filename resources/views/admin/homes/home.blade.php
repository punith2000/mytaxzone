            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header flex items-center justify-between">
                  <h4 class="font-medium">Home/Slider</h4>
                  <a href="{{ route('admin.homes.add_home') }}" class="btn btn-primary"><i class="bi bi-plus"></i> Add Post</a>
                </div>
                <div class="card-body">
                    ...
                    <tbody>
                      @foreach($homes as $home)
                        <tr>
                          <td>{{ $home->id  }}</td>
                          <td>{{ $home->title }}</td>
                          <td class="testimonial-content">{!! $home->content !!}</td>
                          <td>
                            @if($home->image)
                              <img src="{{ asset($home->image) }}" width="100">
                            @endif
                          </td>
                          <td>
                            <a href="{{ route('admin.homes.show', $home->id) }}" class="btn btn-primary btn-sm">
                              <i class="fa fa-eye"></i>
                            </a>
                            <a href="{{ route('admin.homes.edit', $home->id) }}" class="btn btn-success btn-sm">
