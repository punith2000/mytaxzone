            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header flex items-center justify-between">
                  ...
                  <a href="{{ route('admin.abouts.add_about') }}" class="btn btn-primary"><i class="bi bi-plus"></i> Add Post</a>
                </div>
                <div class="card-body">
                  @session('success')
                  ...
                  <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                      @foreach($abouts as $about)
                        <tr>
                          <td>{{ $about->id  }}</td>
                          <td class="about-content">{{ $about->title }}</td>
                          ...
                          <td>{{ $about->label3 }}</td>
                          <td>
                            <a href="{{ route('admin.abouts.show', $about->id) }}" class="btn btn-primary btn-sm">
                              <i class="fa fa-eye"></i>
                            </a>
                            <a href="{{ route('admin.abouts.edit', $about->id) }}" class="btn btn-success btn-sm">
