            ...
            <div class="card card-box mb-4">
              ...
              <div class="card-body">
                ...
                <div class="form-group mb-3">
                  ...
                  <input type="text" name="title" value="{{ $about->title }}" class="form-control" id="title" placeholder="Enter the title" required>
                </div>
      
                <!-- Content -->
                <div class="form-group mb-3">
                  <label for="content">Content:</label>
                  <textarea name="content" id="content" rows="6" class="form-control" placeholder="Enter content" required>{!! $about->content !!}</textarea>
                ...
                <div class="form-group mb-3 image-row">
                  <div class="image-col">
                    ...
                    <input type="file" name="image1" value="{{ $about->image1 }}" class="form-control" id="image1">
                  </div>
                  <div class="image-col">
                    <label for="image2">Image 2:</label>
                    <input type="file" name="image2" value="{{ $about->image2 }}" class="form-control" id="image2">
                  </div>
                </div>
                ...
                <div class="form-group mb-3 image-row">
                  <div class="image-col">
                    ...
                    <input type="number" name="count1" value="{{ $about->count1 }}" min="0" class="form-control" id="count1">
                  </div>
                  <div class="image-col">
                    <label for="label1">label 1:</label>
                    <input type="text" name="label1" value="{{ $about->label1 }}" class="form-control" id="label1">
                  </div>
                </div>
                ...
                <div class="form-group mb-3 image-row">
                  <div class="image-col">
                    ...
                    <input type="number" name="count2" value="{{ $about->count2 }}" min="0" class="form-control" id="count2">
                  </div>
                  <div class="image-col">
                    <label for="label2">label 2:</label>
                    <input type="text" name="label2" value="{{ $about->label2 }}" class="form-control" id="label2">
                  </div>
                </div>
                ...
                <div class="form-group mb-3 image-row">
                  <div class="image-col">
                    ...
                    <input type="number" name="count3" value="{{ $about->count3 }}" min="0" class="form-control" id="count3">
                  </div>
                  <div class="image-col">
                    <label for="label3">label 3:</label>
                    <input type="text" name="label3" value="{{ $about->label3 }}" class="form-control" id="label3">
                  </div>
                </div>
