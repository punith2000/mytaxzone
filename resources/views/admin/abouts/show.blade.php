      ...
      <div class="mt-4">
        <div class="mt-4">
          <div class="card card-box mb-2 ms-3 me-3">
            ...
            <div class="card-body">
              <p><strong>ID:</strong> {{ $about->id }}</p><br>
              <p><strong>Title:</strong> {{ $about->title }}</p><br>
              <p><strong>Content:</strong> {!! $about->content !!}</p><br>
              <p><strong>Image 1:</strong><br>
                @if($about->image1)
                  <img src="{{ asset($about->image1) }}" width="30">
                @endif
              </p>
              <p><strong>Image 2:</strong><br>
                @if($about->image2)
                  <img src="{{ asset($about->image2) }}" width="30">
                @endif
              </p>
              <br>
              <p><strong>Count 1:</strong> {{ $about->count1 }}</p><br>
              <p><strong>Label 1:</strong> {{ $about->label1 }}</p><br>
              <p><strong>Count 2:</strong> {{ $about->count2 }}</p><br>
              <p><strong>Label 2:</strong> {{ $about->label2 }}</p><br>
              <p><strong>Count 3:</strong> {{ $about->count3 }}</p><br>
              <p><strong>Label 3:</strong> {{ $about->label3 }}</p><br>
            </div>
          </div>
      </div>    
    </div>
