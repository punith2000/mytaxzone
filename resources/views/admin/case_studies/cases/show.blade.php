    ...
    <div class="pc-container">
      <div class="mt-4">
        <div class="card card-box mb-2 ms-3 me-3">
          ...
          <div class="card-body">
            <p><strong>ID:</strong> {{ $casestudy->id  }}</p><br>
            <p><strong>Title:</strong> {{ $casestudy->title  }}</p><br>
            <p><strong>Content:</strong> {!! $casestudy->content  !!}</p><br>
          </div>
        </div>
      </div>
    </div>
