            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header flex items-center justify-between">
                  <h3 class="font-medium">Case Studies Header</h3>
                  <a href="{{ route('admin.case_studies.cases.add_hd') }}" class="btn btn-primary"><i class="bi bi-plus"></i> Add Post</a>
                </div>
                <div class="card-body">
                  @session('success')
                    ...
                    <tbody>
                      @foreach($casestudies as $casestudy)
                        <tr>
                          ...
                          <td class="testimonial-content">{!! $casestudy->content  !!}</td>
                          <td>
                            <a href="{{ route('admin.case_studies.cases.show', $casestudy->id) }}" class="btn btn-primary btn-sm">
                              <i class="fa fa-eye"></i>
                            </a>
                            <a href="{{ route('admin.case_studies.cases.edit', $casestudy->id) }}" class="btn btn-success btn-sm">
                              <i class="fa fa-edit"></i>
                            </a>
                            <form action="{{ route('admin.case_studies.cases.destroy', $casestudy->id) }}" method="POST" style="display:inline-block;">
                              @csrf
                              @method('DELETE')
