...
<html lang="en" @@bodySetup>
  ...
  <body>
    ...
    <div class="pc-container">
      <form action="{{ route('admin.case_studies.update', $case->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
          <div class="col-md-9">
            <div class="card card-box mb-2">
              ...
              <div class="card-body">
                <div class="form-group">
                  <label>Title: </label>
                  <input type="text" name="title" value="{{ $case->title }}" class="form-control" placeholder="Enter the title" required>
                </div>
                <br>
                ...
                <div class="form-group">
                  ...
                  class="form-control" placeholder="Content" required>{!! $case->content !!}</textarea>
                ...
                <div class="form-group">
                  <label>Role: </label>
                  <input type="text" name="role" value="{{ $case->role }}" class="form-control" placeholder="Role" required>
                </div>
                <br>

                <label for="image">Image:</label>
                <input type="file" name="image" value="{{ $case->image }}" class="form-control" id="image">
                <br>
