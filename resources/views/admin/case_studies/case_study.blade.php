            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header flex items-center justify-between">
                  <h3 class="font-medium">Case Studies</h3>
                  <a href="{{ route('admin.case_studies.add_cs') }}" class="btn btn-primary"><i class="bi bi-plus"></i> Add Post</a>
                </div>
                <div class="card-body">
                  @session('success')
                    ...
                    <tbody>
                      @foreach($cases as $case)
                        <tr>
                          <td>{{ $case->id  }}</td>
                          <td>{{ $case->title }}</td>
                          <td class="testimonial-content">{!! $case->content !!}</td>
                          <td>{{ $case->role }}</td>
                          <td>
                            @if($case->image)
                              <img src="{{ asset($case->image) }}" width="50">
                            @endif
                          </td>
                          <td>
                            <a href="{{ route('admin.case_studies.show', $case->id) }}" class="btn btn-primary btn-sm">
                              <i class="fa fa-eye"></i>
                            </a>
                            <a href="{{ route('admin.case_studies.edit', $case->id) }}" class="btn btn-success btn-sm">
                              <i class="fa fa-edit"></i>
                            </a>
                            <form action="{{ route('admin.case_studies.destroy', $case->id) }}" method="POST" style="display:inline-block;">
                              @csrf
                              @method('DELETE')
                ...
                <div class="center mt-3">
                  <div class="pagination">
                      ...
                      @if ($cases->onFirstPage())
                          <span>&laquo;</span>
                      @else
                          <a href="{{ $cases->previousPageUrl() }}" rel="prev">&laquo;</a>
                      @endif
                      ...
                      @if ($cases->hasMorePages())
                          <a href="{{ $cases->nextPageUrl() }}" rel="next">&raquo;</a>
                      @else
                          <span>&raquo;</span>
                      @endif
                  </div>
