...
<html lang="en" @@bodySetup>
  ...
  <body>
    ...
    <div class="pc-container">
      <form action="{{ route('admin.teams.team.update', $teamhead->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
          <div class="col-md-9">
            <div class="card card-box mb-2">
              <div class="card-header">
                <h3>Team Header Edit
                  <a href="{{ route('admin.teams.team.teams') }}" class="btn btn-danger float-end">
              ...
              <div class="card-body">
                <div class="form-group">
                  <label>Title: </label>
                  <input type="text" name="title" value="{{ $teams->title  }}" class="form-control" placeholder="Enter the title" required>
                </div>
                <br>
                ...
                <div class="form-group">
                  ...
                  class="form-control" placeholder="Content" required>{!! $teams->content  !!}</textarea>
