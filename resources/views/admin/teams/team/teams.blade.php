            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header flex items-center justify-between">
                  <h4 class="font-medium">Team Header</h4>
                  <a href="{{ route('admin.teams.team.add_teams') }}" class="btn btn-primary"><i class="bi bi-plus"></i> Add Post</a>
                </div>
                <div class="card-body">
                  @session('success')
                  ...
                  <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                      @foreach($teamheader as $teamhead)
                        <tr>
                          <td>{{ $teamhead->id  }}</td>
                          <td>{{ $teamhead->title }}</td>
                          <td class="testimonial-content">{!! $teamhead->content !!}</td>
                          <td>
                            <a href="{{ route('admin.teams.team.show', $teamhead->id) }}" class="btn btn-primary btn-sm">
                              <i class="fa fa-eye"></i>
                            </a>
                            <a href="{{ route('admin.teams.team.edit', $teamhead->id) }}" class="btn btn-success btn-sm">
                              <i class="fa fa-edit"></i>
                            </a>
                            <form action="{{ route('admin.teams.team.destroy', $teamhead->id) }}" method="POST" style="display:inline-block;">
                              @csrf
                              @method('DELETE')
