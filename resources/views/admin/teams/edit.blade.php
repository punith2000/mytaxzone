          ...
          <div class="col-md-9">
            <div class="card card-box mb-2">
              <div class="card-header">
                <h3>Team
                  <a href="{{ route('admin.teams.team') }}" class="btn btn-danger float-end">
              ...
              <div class="card-body">
                <div class="form-group">
                  <label>Name: </label>
                  <input type="text" name="name" value="{{ $team->name }}" class="form-control" placeholder="Enter the name" required>
                </div>
                <br>

                <div class="form-group">
                  <label>Designation: </label>
                  <input type="text" name="designation" value="{{ $team->designation }}" class="form-control" placeholder="Designation" required>
                </div>
                <br>
