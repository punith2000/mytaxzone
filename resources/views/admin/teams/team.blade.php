            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header flex items-center justify-between">
                  <h4 class="font-medium">Teams</h4>
                  <a href="{{ route('admin.teams.add_team') }}" class="btn btn-primary"><i class="bi bi-plus"></i> Add Post</a>
                </div>
                <div class="card-body">
                  @session('success')
                    ...
                    <tbody>
                      @foreach($teams as $team)
                        <tr>
                          ...
                          <td>
                            @if($team->image)
                              <img src="{{ asset($team->image) }}" width="60">
                            @endif
                          </td>
                          <td>
                            <a href="{{ route('admin.teams.show', $team->id) }}" class="btn btn-primary btn-sm">
                              <i class="fa fa-eye"></i>
                            </a>
                            <a href="{{ route('admin.teams.edit', $team->id) }}" class="btn btn-success btn-sm">
                ...
                <div class="center mt-3">
                  <div class="pagination">
                      ...
                      @if ($teams->onFirstPage())
                          <span>&laquo;</span>
                      @else
                          <a href="{{ $teams->previousPageUrl() }}" rel="prev">&laquo;</a>
                      @endif
                      ...
                      @if ($teams->hasMorePages())
                          <a href="{{ $teams->nextPageUrl() }}" rel="next">&raquo;</a>
                      @else
                          <span>&raquo;</span>
                      @endif
                  </div>
