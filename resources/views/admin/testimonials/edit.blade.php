          ...
          <div class="col-md-9">
            <div class="card card-box mb-2">
              <div class="card-header">
                <h3>Testimonial
                  <a href="{{ route('admin.testimonials.test') }}" class="btn btn-danger float-end">
              ...
              <div class="card-body">
                <div class="form-group">
                  <label>Name: </label>
                  <input type="text" name="name" value="{{ $testimonial->name }}" class="form-control" placeholder="Enter the name" required>
                </div>
                <br>
                ...
                <div class="form-group">
                  ...
                  class="form-control" placeholder="Content" required>{!! $testimonial->content !!}</textarea>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="designation" value="{{ $testimonial->designation }}" class="form-control" placeholder="Designation" required>
                </div>
                <br>
