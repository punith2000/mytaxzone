      ...
      <div class="navbar-wrapper">
        <div class="m-header flex items-center py-4 px-6 h-header-height">
          <a href="{{ route('admin.dashboard') }}" class="b-brand flex items-center gap-3">
            ...
            {{-- <img src="{{ asset('admin/images/logo-ico.png') }}" /> --}}
          </a>
        </div>
            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header flex items-center justify-between">
                  <h4 class="font-medium">Testimonials</h4>
                  <a href="{{ route('admin.testimonials.add_test') }}" class="btn btn-primary"><i class="bi bi-plus"></i> Add Post</a>
                </div>
                <div class="card-body">
                  @session('success')
                    ...
                    <tbody>
                      @foreach($testimonials as $testimonial)
                        <tr>
                          ...
                          <td class="testimonial-content">{!! $testimonial->content !!}</td>
                          <td>
                            @if($testimonial->image)
                              <img src="{{ asset($testimonial->image) }}" width="50">
                              {{-- <img src="{{ asset('storage/' . $testimonial->image) }}" alt="Post Image" class="img-fluid" style="width: 100px; height: auto;"> --}}
                            @endif
                          </td>
                          <td>
                            <a href="{{ route('admin.testimonials.show', $testimonial->id) }}" class="btn btn-primary btn-sm">
                              <i class="fa fa-eye"></i>
                            </a>
                            <a href="{{ route('admin.testimonials.edit', $testimonial->id) }}" class="btn btn-success btn-sm">
