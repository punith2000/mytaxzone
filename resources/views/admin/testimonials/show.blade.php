    ...
    <div class="pc-container">
      <div class="mt-4">
        <div class="card card-box mb-2 ms-3 me-3">
          ...
          <div class="card-body">
            <p><strong>ID:</strong> {{ $testimonial->id }}</p><br>
            <p><strong>Name:</strong> {{ $testimonial->name }}</p><br>
            <p><strong>Designation:</strong> {{ $testimonial->designation }}</p><br>
            <p><strong>Content:</strong> {!! $testimonial->content !!}</p><br>
            <p><strong>Image:</strong><br>
              @if($testimonial->image)
                <img src="{{ asset($testimonial->image) }}" width="250">
              @endif
            </p>
          </div>
        </div>
