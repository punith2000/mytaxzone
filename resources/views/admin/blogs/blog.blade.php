            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header flex items-center justify-between">
                  <h4 class="font-medium">Blogs</h4>
                  <a href="{{ route('admin.blogs.add_blog') }}" class="btn btn-primary"><i class="bi bi-plus"></i> Add Post</a>
                </div>
                <div class="card-body">
                  @session('success')
                  ...
                  <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                      @foreach($blogs as $blog)
                        <tr>
                          <td>{{ $blog->id  }}</td>
                          <td class="about-content">{{ $blog->title }}</td>
                          <td class="about-content">{!! $blog->content !!}</td>
                          <td>
                            @if($blog->image)
                          ...
                          <td>
                            @if($blog->author_image)
                              <img src="{{ asset($blog->author_image) }}" width="40">
                            @endif
                          </td>
                          <td>{{ $blog->created_at->format('d-m-Y') }}</td>
                          <td>
                            <a href="{{ route('admin.blogs.show', $blog->id) }}" class="btn btn-primary btn-sm">
                              <i class="fa fa-eye"></i>
                            </a>
                            <a href="{{ route('admin.blogs.edit', $blog->id) }}" class="btn btn-success btn-sm">
