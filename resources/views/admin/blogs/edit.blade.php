          ...
          <div class="col-md-12">
            <div class="card card-box mb-4">
              <div class="card-header">
                <h3>Blog
                  <a href="{{ route('admin.blogs.blog') }}" class="btn btn-danger float-end">
              ...
              <div class="card-body">
                ...
                <div class="form-group mb-3">
                  ...
                  <input type="text" name="title" value="{{ $blog->title }}" class="form-control" id="title" placeholder="Enter the title" required>
                </div>
      
                <!-- Content -->
                <div class="form-group mb-3">
                  <label for="content">Content:</label>
                  <textarea name="content" id="content" rows="6" class="form-control" placeholder="Enter content" required>{!! $blog->content !!}</textarea>
                ...
                <div class="form-group mb-3 image-row">
                  <div class="image-col">
                    ...
                    <input type="text" name="author_name" value="{{ $blog->author_name }}" class="form-control" placeholder="Enter author name" required>
                  </div>
                  <div class="image-col">
                    <label for="author_image">Author-Image: </label>
                    <input type="file" name="author_image" class="form-control" id="author_image" required>
                  </div>
                </div>
