    ...
    <div class="pc-container">
      <div class="mt-4">
        <div class="card card-box mb-2 ms-3 me-3">
          ...
          <div class="card-body">
            <p><strong>ID:</strong> {{ $blog->id }}</p><br>
            <p><strong>Title:</strong> {{ $blog->title }}</p><br>
            <p><strong>Content:</strong> {!! $blog->content !!}</p><br>
            <p><strong>Image:</strong><br>
              @if($blog->image)
                <img src="{{ asset($blog->image) }}" width="200">
              @endif
            </p><br>
            <p><strong>Author Name:</strong> {{ $blog->author_name }}</p><br>
            <p><strong>Author Image:</strong> 
              @if($blog->author_image)
                <img src="{{ asset($blog->author_image) }}" width="30">
              @endif
            </p><br>
            <p><strong>Publishes_at: </strong> {{ $blog->created_at->format('d-m-Y') }}</p>
          </div>
        </div>
      </div>   
    </div>
