            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header flex items-center justify-between">
                  <h3 class="font-medium">Blogs Header</h3>
                  <a href="{{ route('admin.blogs.bloghead.add_blog_head') }}" class="btn btn-primary"><i class="bi bi-plus"></i> Add Post</a>
                </div>
                <div class="card-body">
                  @session('success')
                  ...
                  <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                      @foreach($blogheader as $bloghead)
                        <tr>
                          <td>{{ $bloghead->id  }}</td>
                          <td>{{ $bloghead->title  }}</td>
                          <td class="testimonial-content">{!! $bloghead->content  !!}</td>
                          <td>
                            <a href="{{ route('admin.blogs.bloghead.show', $bloghead->id) }}" class="btn btn-primary btn-sm">
                              <i class="fa fa-eye"></i>
                            </a>
                            <a href="{{ route('admin.blogs.bloghead.edit', $bloghead->id) }}" class="btn btn-success btn-sm">
                              <i class="fa fa-edit"></i>
                            </a>
                            <form action="{{ route('admin.blogs.bloghead.destroy', $bloghead->id) }}" method="POST" style="display:inline-block;">
                              @csrf
                              @method('DELETE')
