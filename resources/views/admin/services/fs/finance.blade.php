            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header flex items-center justify-between">
                  <h4 class="font-medium">Finance Service</h4>
                  <a href="{{ route('admin.services.fs.add_fs') }}" class="btn btn-primary"><i class="bi bi-plus"></i> Add Post</a>
                </div>
                <div class="card-body">
                  @session('success')
                    ...
                    <tbody>
                      @foreach($finance as $fs)
                        <tr>
                          <td>{{ $fs->id  }}</td>
                          <td>{{ $fs->title }}</td>
                          <td class="testimonial-content">{!! $fs->content !!}</td>
                          <td>
                            @if($fs->image)
                              <img src="{{ asset($fs->image) }}" width="50">
                            @endif
                          </td>
                          <td>
                            <a href="{{ route('admin.services.fs.show', $fs->id) }}" class="btn btn-primary btn-sm">
                              <i class="fa fa-eye"></i>
                            </a>
                            <a href="{{ route('admin.services.fs.edit', $fs->id) }}" class="btn btn-success btn-sm">
                              <i class="fa fa-edit"></i>
                            </a>
                            <form action="{{ route('admin.services.fs.destroy', $fs->id) }}" method="POST" style="display:inline-block;">
                              @csrf
                              @method('DELETE')
