    ...
    <div class="pc-container">
      <div class="mt-4">
        <div class="card card-box mb-2 ms-3 me-3">
          ...
          <div class="card-body">
            <p><strong>ID:</strong> {{ $fs->id }}</p><br>
            <p><strong>Title:</strong> {{ $fs->title }}</p><br>
            <p><strong>Content:</strong> {!! $fs->content !!}</p><br>
            <p><strong>Image:</strong><br>
              @if($fs->image)
                <img src="{{ asset($fs->image) }}" width="200">
              @endif
            </p>
          </div>
        </div>
