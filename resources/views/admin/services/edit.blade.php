          ...
          <div class="col-md-9">
            <div class="card card-box mb-2">
              <div class="card-header">
                <h3>Services
                  <a href="{{ route('admin.services.service') }}" class="btn btn-danger float-end">
              ...
              <div class="card-body">
                <div class="form-group">
                  <label>Title: </label>
                  <input type="text" name="title" value="{{ $service->title }}" class="form-control" placeholder="Enter the title" required>
                </div>
                <br>
                ...
                <div class="form-group">
                  ...
                  class="form-control" placeholder="Content" required>{!! $service->content !!}</textarea>
