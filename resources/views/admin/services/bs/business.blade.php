            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header flex items-center justify-between">
                  <h4 class="font-medium">Business Service</h4>
                  <a href="{{ route('admin.services.bs.add_bs') }}" class="btn btn-primary"><i class="bi bi-plus"></i> Add Post</a>
                </div>
                <div class="card-body">
                  @session('success')
                    ...
                    <tbody>
                      @foreach($business as $bs)
                        <tr>
                          <td>{{ $bs->id  }}</td>
                          <td>{{ $bs->title }}</td>
                          <td class="testimonial-content">{!! $bs->content !!}</td>
                          <td>
                            @if($bs->image)
                              <img src="{{ asset($bs->image) }}" width="50">
                            @endif
                          </td>
                          <td>
                            <a href="{{ route('admin.services.bs.show', $bs->id) }}" class="btn btn-primary btn-sm">
                              <i class="fa fa-eye"></i>
                            </a>
                            <a href="{{ route('admin.services.bs.edit', $bs->id) }}" class="btn btn-success btn-sm">
                              <i class="fa fa-edit"></i>
                            </a>
                            <form action="{{ route('admin.services.bs.destroy', $bs->id) }}" method="POST" style="display:inline-block;">
                              @csrf
                              @method('DELETE')
