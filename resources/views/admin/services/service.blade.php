            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header flex items-center justify-between">
                  ...
                  <a href="{{ route('admin.services.add_service') }}" class="btn btn-primary"><i class="bi bi-plus"></i> Add Post</a>
                </div>
                <div class="card-body">
                  @session('success')
                    ...
                    <tbody>
                      @foreach($services as $service)
                        <tr>
                          <td>{{ $service->id  }}</td>
                          <td>{{ $service->title }}</td>
                          <td class="testimonial-content">{!! $service->content !!}</td>
                          <td>
                            @if($service->image)
                          ...
                          <td>
                            <a href="{{ route('admin.services.show', $service->id) }}" class="btn btn-primary btn-sm">
                              <i class="fa fa-eye"></i>
                            </a>
                            <a href="{{ route('admin.services.edit', $service->id) }}" class="btn btn-success btn-sm">
                ...
                <div class="center mt-3">
                  <div class="pagination">
                      ...
                      @if ($services->onFirstPage())
                          <span>&laquo;</span>
                      @else
                          <a href="{{ $services->previousPageUrl() }}" rel="prev">&laquo;</a>
                      @endif
                      ...
                      @if ($services->hasMorePages())
                          <a href="{{ $services->nextPageUrl() }}" rel="next">&raquo;</a>
                      @else
                          <span>&raquo;</span>
                      @endif
                  </div>
