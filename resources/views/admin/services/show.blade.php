    ...
    <div class="pc-container">
      <div class="mt-4">
        <div class="card card-box mb-2 ms-3 me-3">
          ...
          <div class="card-body">
            <p><strong>ID:</strong> {{ $service->id }}</p><br>
            <p><strong>Title:</strong> {{ $service->title }}</p><br>
            <p><strong>Content:</strong> {!! $service->content !!}</p><br>
            <p><strong>Image:</strong><br>
              @if($service->image)
                <img src="{{ asset($service->image) }}" width="200">
              @endif
            </p>
          </div>
        </div>
