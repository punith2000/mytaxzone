    ...
    <div class="pc-container">
      <div class="mt-4">
        <div class="card card-box mb-2 ms-3 me-3">
          ...
          <div class="card-body">
            <p><strong>ID:</strong> {{ $invest->id }}</p><br>
            <p><strong>Title:</strong> {{ $invest->title }}</p><br>
            <p><strong>Content:</strong> {!! $invest->content !!}</p><br>
            <p><strong>Image:</strong><br>
              @if($invest->image)
                <img src="{{ asset($invest->image) }}" width="200">
              @endif
            </p>
          </div>
        </div>
