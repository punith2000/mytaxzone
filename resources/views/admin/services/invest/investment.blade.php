            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header flex items-center justify-between">
                  <h4 class="font-medium">Investment Service</h4>
                  <a href="{{ route('admin.services.invest.add_invest') }}" class="btn btn-primary"><i class="bi bi-plus"></i> Add Post</a>
                </div>
                <div class="card-body">
                  @session('success')
                    ...
                    <tbody>
                      @foreach($investment as $invest)
                        <tr>
                          <td>{{ $invest->id  }}</td>
                          <td>{{ $invest->title }}</td>
                          <td class="testimonial-content">{!! $invest->content !!}</td>
                          <td>
                            @if($invest->image)
                              <img src="{{ asset($invest->image) }}" width="50">
                            @endif
                          </td>
                          <td>
                            <a href="{{ route('admin.services.invest.show', $invest->id) }}" class="btn btn-primary btn-sm">
                              <i class="fa fa-eye"></i>
                            </a>
                            <a href="{{ route('admin.services.invest.edit', $invest->id) }}" class="btn btn-success btn-sm">
                              <i class="fa fa-edit"></i>
                            </a>
                            <form action="{{ route('admin.services.invest.destroy', $invest->id) }}" method="POST" style="display:inline-block;">
                              @csrf
                              @method('DELETE')
