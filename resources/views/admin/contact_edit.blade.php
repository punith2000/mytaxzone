              ...
              <div class="card-body">
                <div class="form-group mb-3 image-row">
                  <div class="image-col">
                    ...
                    <input type="text" id="form_name" name="name" value="{{ $contact->name }}" class="form-control" placeholder="Your name" required>
                  </div>
                  <div class="image-col">
                    <label for="form_email" class="form-label">Email</label>
                    <input type="email" id="form_email" name="email" value="{{ $contact->email }}" class="form-control" placeholder="you@example.com" required>
                  </div>
                </div>
                <br>
                ...
                <div class="form-group mb-3 image-row">
                  <div class="image-col">
                    ...
                    <input type="tel" id="form_phone" name="phone" value="{{ $contact->phone }}" class="form-control" placeholder="+91 12345 67890">
                  </div>
                  <div class="image-col">
                    <label for="form_subject" class="form-label">Subject</label>
                  <input type="text" id="form_subject" name="subject" value="{{ $contact->subject }}" class="form-control" placeholder="Brief subject" required>
                  </div>
                </div>
                <br>
                ...
                <div class="col-md-12">
                  ...
                  <textarea id="form_message" name="message" rows="5" class="form-control" placeholder="Your message..." required>
                    {{ $contact->message }}
                  </textarea>
                </div>
                <br>
